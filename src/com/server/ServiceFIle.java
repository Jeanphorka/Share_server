...
public class ServiceFIle {
    ...
    //  SQL
    private final String PATH_FILE = "D:\\NetBeansProjects\\server\\server_data/";
    private final String INSERT = "insert into files (FileExtensions) values (?)";
    ...
    private final String GET_FILE_EXTENSION = "select FileExtensions from files where FileID=? limit 1";
    //  Instance
